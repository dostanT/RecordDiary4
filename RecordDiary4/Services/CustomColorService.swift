...
//    
    static let red = Color("RedAppCustom")
    static let orange = Color("OrangeAppCustom")
    static let yellow = Color("YellowAppCustom")
    static let green = Color("GreenAppCustom")
    static let blue = Color("BlueAppCustom")
    static let purple = Color("PurpleAppCustom")
    static let pink = Color("PinkAppCustom")
    static let cyan = Color("CyanAppCustom")
    static let grayLight = Color("GrayLightAppCustom")
    static let black = Color("BlackAppCustom")
    static let white = Color("WhiteAppCustom")
    static let beige = Color("BeigeAppCustom")
}
